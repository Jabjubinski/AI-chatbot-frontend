...
export default function SearchConversationsPage() {
  ...
  return (
    <div ref={modalRef} className="bg-transparent h-full p-6 w-full mx-4">
      ...
      <input
        ...
        className="w-full px-4 py-2 mb-4 rounded-lg border border-neutral-300 dark:border-neutral-700 
                    bg-neutral-50 dark:bg-neutral-800   dark:text-neutral-100 
                    focus:outline-none focus:ring-2 focus:ring-blue-500"
      />

      <div className="flex-1 overflow-y-auto space-y-2 w-full min-w-full">
        {conversations.length > 0 ? (
          ...
          <p className=" dark:text-neutral-400 text-center py-4">
